...
// https://informatics.msk.ru/mod/statements/view.php?chapterid=1436#1
public class InsertionSortInformatics {
    ...
    private void printArr(int[] a) {
        ...
        operations.add(response.toString());
    }
    ...
    public static void main(String[] args) {
        new InsertionSortInformatics().run();
    }
