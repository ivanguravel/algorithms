package org.ivzh.graph;//package graph;
...
// https://acmp.ru/asp/do/index.asp?main=task&id_course=2&id_section=21&id_topic=51&id_problem=651
public class GardenBeds {
    ...
    private boolean isValid(int x, int y) {
        ...
        boolean hasDash = matrix[x][y] == '#';
        return notVisited && hasDash;
    }
